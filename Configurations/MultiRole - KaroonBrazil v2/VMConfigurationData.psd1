...
@{
    AllNodes    = @(
        @{
            ...
            DomainName                  = "karoonbrasil.com.br"
            DomainDN                    = "DC=karoonbrasil,DC=com,DC=br"
            ...
            SecureBoot                  = $true
            Lability_Media              = '2019_x64_Datacenter_EN_Eval'
            <#
        ...
        Lability = @{
            ...
            Media       = @(
                @{
                    ...
                    Filename = 'TD01WS08SFR2SP1x64.vhd';
                    Description     = 'Windows Server 2008 R2';
                    Architecture    = 'x64';
                    ImageName       = '1';
                    MediaType       = 'VHD';
                    OperatingSystem = 'Windows';
                    Uri = 'file://C:\autolab\MasterVirtualHardDisks\TD01WS08SFR2SP1x64.vhd';
                    Checksum        = '';
                    CustomData      = @{
<#                         SetupComplete = 'CoreCLR';
                ...
                @{
                    Id              = '2008R2_x64_ISO';
                    Filename        = '2008R2_x64_ISO.iso';
                    Description     = 'Windows Server 2008 R2';
                    Architecture    = 'x64';
                    ImageName       = '1';
                    MediaType       = 'ISO';
                    OperatingSystem = 'Windows';
                    Uri             = 'file://C:\autolab\ISOs\en_windows_server_2008_r2_x64_dvd_x15-50365.iso';
                    Checksum        = '';
                    CustomData      = @{
<#                         SetupComplete = 'CoreCLR';
                        PackagePath   = '\NanoServer\Packages';
